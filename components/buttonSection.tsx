  ...
  return (
    <div className='md:mt-12 mt-8 max-md:mx-auto'>
        <div className='flex max-md:absolute px-20 max-md:px-4 max-md:left-0 max-md:border-b-[1px] border-gray-100 md:relative w-screen max-md:overflow-x-scroll'>
            ...
            <button onClick={()=>{setSelected("Analysis")}} className={`h-16 flex md:text-xl text-md items-center justify-center px-4 duration-150 ${selected == "Analysis" ? "text-black border-b-[6px] border-b-indigo-600" : "text-gray-400"} `}>Analysis</button>
            <button onClick={()=>{setSelected("Settings")}} className={`h-16 flex md:text-xl text-md items-center justify-center px-4 duration-150 ${selected == "Settings" ? "text-black border-b-[6px] border-b-indigo-600" : "text-gray-400"} `}>Settings</button>
